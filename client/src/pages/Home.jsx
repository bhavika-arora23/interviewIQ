                ...
                <div className='max-w-6xl mx-auto'>
                    <div className='flex justify-center mb-6'>
                        <div className='bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
                            ...
                            AI Powered Smart Interview Platforms
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
                        {
                            [
                                ...
                                <motion.div key={index}
                                    ...
                                    className={`relative bg-white rounded-3xl border-2 border-green-100 hover:border-green-500 p-8 w-80 max-w-[90%] shadow-md hover:shadow-2xl
                        ...
                        <div className='grid md:grid-cols-2 gap-10'>
                            {
                                [
                                    {
                                        image: evalImg,
                                        icon: <BsBarChart sixe={20} />,
                                        title: "AI Answer Evaluation",
                                        desc: "Scores communication, technical accuracy and confidence."
                                    },
                                    {
                                        image: resumeImg,
                                        icon: <BsFileEarmarkText sixe={20} />,
                                        title: "Resume Based Interview",
                                        desc: "project-specific wuestions based on uploaded resume."
                                    },
                                    {
                                        image: pdfImg,
                                        icon: <BsFileEarmarkText sixe={20} />,
