        ...
        <motion.div
            ...
            <div className='w-full max-w-4xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
                <motion.div
                    ...
                    className='relative bg-gradient-to-br from-green-50 to-green-100 p-5 flex flex-col justify-center'>
                                ...
                                {skills.length > 0 && (
                                    <div>
                                        ...
                                        <ul className='flex flex-wrap gap-2'>
                                            {skills.map((s, i) => (
                                                <li key={i} className='bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm '>{s}</li>
                                            ))}
